...
contains
  ...
  subroutine addglobal (ncid, cmdline)
    ...
    character(len=256):: version = &
         "$HeadURL: https://svn-ccsm-models.cgd.ucar.edu/clm2/branch_tags/cesm1_1_1_rel_tags/cesm1_1_1_n01_clm4_0_54/models/lnd/clm/tools/interpinic/src/interpinic.F90 $"
